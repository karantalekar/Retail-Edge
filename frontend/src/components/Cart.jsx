...
//         <h2 className="text-primary fw-bold">🧾 Retail Edge Billing System</h2>
...
//                     />
//                     <h6 className="fw-bold text-dark mt-2">{product.name}</h6>
...
//                     {/* Navigate to GenerateBill and pass cart */}
//                     <button
