...
const GenerateBill = () => {
  ...
  //   // Add logo
  //   const logoImg = "https://cdn-icons-png.flaticon.com/512/3076/3076896.png"; // replace with your logo
  ...
  //   doc.setFillColor(23, 162, 184); // Bootstrap info color
  //   doc.rect(14, 30, pageWidth - 28, 20, "F");

  //   doc.setFontSize(12);
  //   doc.setTextColor(255, 255, 255); // white text
  //   doc.text(`Customer Name: ${customer.name}`, 16, 42);
  //   doc.text(`Mobile: ${customer.mobile}`, 80, 42);
  //   doc.text(`Email: ${customer.email}`, 140, 42);

  //   // Table header
  //   let startY = 55;
  //   doc.setFillColor(0, 123, 255); // Bootstrap primary
  ...
  //       colPositions[i],
  //       startY - 6,
  //       i === 0 ? 36 : i === 1 ? 60 : i === 2 ? 30 : 30,
  //       8,
  //       "F"
  //     );
  //     doc.text(header, colPositions[i] + 1, startY);
  //   });
  ...
  //     const fill = index % 2 === 0 ? [224, 224, 224] : [255, 255, 255]; // alternate row colors
  ...
  const saveBill = async () => {
    try {
      ...
      console.error(err);
      alert("Failed to save bill , Enter Customer Credential's ");
    } finally {
      setSaving(false);
    }
  };
